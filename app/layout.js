  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="antialiased font-sans text-gray-900 bg-white">
        ...
        {/* WHATSAPP */}
        <a href="https://wa.me/14074891867" className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-2xl z-50 flex items-center gap-2 group">
