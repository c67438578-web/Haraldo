  ...
  return (
    <html lang="en" className="scroll-smooth">
      ...
      <body className="antialiased font-sans text-gray-900 bg-white">
        ...
        <a 
          href="https://wa.me/14074891834" 
          target="_blank" 
          rel="noopener noreferrer"
          className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full shadow-2xl z-50 flex items-center gap-2 group transition-transform hover:scale-110"
        >
          <MessageCircle size={28} />
          <span className="max-w-0 overflow-hidden group-hover:max-w-xs transition-all duration-500 font-bold px-0 group-hover:px-2">
            Emergency Chat
          </span>
        </a>
      </body>
