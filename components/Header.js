"use client"; // Permite a interatividade
    ...
    <header className="bg-white/95 backdrop-blur-md shadow-sm sticky top-0 z-50 border-b border-gray-100">
      <div className="container mx-auto px-4 py-4 flex justify-between items-center">
        ...
        <nav className="hidden md:flex items-center gap-8">
          ...
          <Link href="/contact" className="bg-red-600 text-white px-6 py-2.5 rounded-lg hover:bg-red-700 font-bold text-sm">
            BOOK ONLINE
          </Link>
        </nav>

        {/* Botão Mobile com Lógica */}
        <button 
      ...
      {/* Menu Mobile que aparece ao clicar */}
      <div className={`${isOpen ? "block" : "hidden"} md:hidden bg-white border-t border-gray-100 absolute w-full left-0 shadow-lg`}>
        <div className="flex flex-col p-4 gap-4 font-bold text-gray-700">
          ...
          <Link 
            ...
            className="bg-red-600 text-white p-3 rounded-lg text-center"
          >
            BOOK ONLINE
          </Link>
        </div>
